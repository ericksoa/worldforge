  ...
  normandy_10th: [
    {
      ...
      choiceA: {
        ...
        worldEvents: ['Military encampments spread across the frontier', 'Viking war drums echo'],
        landmarks: [{ name: 'Ironhold', type: 'fortress', description: 'A formidable fortress on the frontier' }],
      },
      choiceB: {
        label: 'The Merchant',
        ...
        worldEvents: ['Markets flourish with foreign goods', 'Trade routes expand'],
        landmarks: [{ name: 'Portbury', type: 'settlement', description: 'A bustling trading hub on the coast' }],
      },
    },
    {
      ...
      choiceA: {
        ...
        worldEvents: ['Pilgrims gather from distant lands', 'Church bells ring at dawn'],
        landmarks: [{ name: 'Saint-Wandrille', type: 'monastery', description: 'A grand monastery dedicated to the faith' }],
      },
      choiceB: {
        ...
        worldEvents: ['Tolerance grows among the people', 'Old traditions persist'],
        landmarks: [{ name: 'Old Temple Ruins', type: 'ruin', description: 'Ancient ruins of forgotten gods' }],
      },
    },
    {
      id: 'order_vs_freedom',
      ...
      choiceA: {
        ...
        worldEvents: ['Courts are established in every village', 'Justice is swift'],
        landmarks: [{ name: 'Justicar Keep', type: 'fortress', description: 'The seat of law and order' }],
      },
      choiceB: {
        label: 'The Liberator',
        ...
        worldEvents: ['Local assemblies gain power', 'The people speak freely'],
        landmarks: [{ name: 'Freehaven', type: 'settlement', description: 'A town where all are welcome' }],
      },
    },
    {
      id: 'build_vs_destroy',
      ...
      choiceA: {
        ...
        worldEvents: ['Craftsmen gather from distant lands', 'Stone quarries open'],
        landmarks: [{ name: 'Stoneheart', type: 'fortress', description: 'A mighty castle of enduring stone' }],
      },
      choiceB: {
        label: 'The Shepherd',
        ...
        worldEvents: ['The old forests grow thick again', 'Nature reclaims'],
        landmarks: [{ name: 'Elderwood', type: 'natural', description: 'An ancient sacred forest' }],
      },
    },
    {
      id: 'ally_vs_isolate',
      ...
      choiceA: {
        ...
        worldEvents: ['Foreign merchants arrive daily', 'Treaties are signed'],
        landmarks: [{ name: 'Embassy Hall', type: 'settlement', description: 'A grand hall for foreign dignitaries' }],
      },
      choiceB: {
        label: 'The Fortress',
        ...
        worldEvents: ['Border garrisons strengthen', 'Walls grow higher'],
        landmarks: [{ name: 'Wardwall', type: 'fortress', description: 'An impenetrable border fortress' }],
      },
    },
  ],
}
